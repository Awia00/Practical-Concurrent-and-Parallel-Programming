...
public class TestCache {
  ...
  public static void main(String[] args) {
    ...
    Mark7("Memoizer1", i -> exerciseFactorizer(1));
    Mark7("Memoizer2", i -> exerciseFactorizer(2));
    Mark7("Memoizer3", i -> exerciseFactorizer(3));
    Mark7("Memoizer4", i -> exerciseFactorizer(4));
    Mark7("Memoizer5", i -> exerciseFactorizer(5));
    Mark7("Memoizer0", i -> exerciseFactorizer(0));
  ...
  private static long exerciseFactorizer(int memoizer) {
    final Computable<Long, long[]> factorizer = new Factorizer();
    final Computable<Long, long[]> f;
    switch(memoizer)
    {
      case 0:
        f = new Memoizer0<Long,long[]>(factorizer);
        break;
      case 1:
        f = new Memoizer1<Long,long[]>(factorizer);
        break;
      case 2:
        f = new Memoizer2<Long,long[]>(factorizer);
        break;
      case 3:
        f = new Memoizer3<Long,long[]>(factorizer);
        break;
      case 4:
        f = new Memoizer4<Long,long[]>(factorizer);
        break;
      case 5:
        f = new Memoizer5<Long,long[]>(factorizer);
        break;
      default:
        f = new Memoizer1<Long,long[]>(factorizer);
        break;
    ...
    return ((Factorizer)factorizer).getCount();
  }
